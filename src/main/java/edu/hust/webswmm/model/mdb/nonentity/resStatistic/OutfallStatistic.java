...
public class OutfallStatistic {
    ...
    public OutfallStatistic(String id, String type, Date startTime, Date endTime, double aveDepth, double maxDepth, double maxHGL, Date maxTimeDepth, double maxLateralFlow, double maxInFlow, Date maxTimeInflow, double latFlowVolume, double totalFlowVolume, double avgFlow) {
        this.id = id;
        this.type = type;
